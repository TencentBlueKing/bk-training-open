    ...
    export default {
        ...
        methods: {
            ...
            addGroup () {
                ...
                console.log(this.addGroupData.formData)
                this.$http.post('/add_group/', { name: '你啦啦啦啦啦', admin: [{ username: '1439011429Q', telephone: '19884687266', id: 135, email: '1439011429@qq.com', display_name: '尤子龙', disabled: true }] }).then(res => {
                    const config = {}
                    config.offsetY = 80
                    config.message = res.message
                    if (res.result) {
