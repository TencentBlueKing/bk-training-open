...
from config.default import BKAPP_FULL_SITE_URL
...
def notify_admin_group_info(admin_username: str, group_infos: list, date=None):
    ...
    :param group_infos:     组信息list，具体数据格式如下：
                            [{
                                ...
                                "group_link": BKAPP_FULL_SITE_URL + "manage-group?date=2021-12-3&group=1"  # 组管理页面
                            },]
...
def notify_yesterday_report_info(report_date=None):
    ...
    for g_id in group_ids:
        ...
        g_info_for_mail = {
            ...
            "group_link": "{}manage-group?date={}&group={}".format(BKAPP_FULL_SITE_URL, report_date_str, g_id),  # 组管理页面
        }
